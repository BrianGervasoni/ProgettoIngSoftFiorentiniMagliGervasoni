...
import progettoAI.snakeAI.AI.model.*;
import progettoAI.snakeAI.SnakeLogic.boxes.Direction;
import progettoAI.snakeAI.SnakeLogic.game.GameMain;
...
public class ThreadAgent extends Thread implements Functions{
	...
	public double calculateReward() {
		...
		double rewardDefault = 0.0, rewardDistanceApple=0, rewardGetApple = 5, rewardDead = -5,rewardTick=0, rewardNearWall = 0;
